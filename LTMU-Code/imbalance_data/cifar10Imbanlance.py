...
class Cifar10Imbanlance_forget(Dataset):
    def __init__(self, imbanlance_rate, forget_class=None, num_cls=10, file_path="data/",
                 train=True, transform=None, label_align=True, forget=False, input_aug=False):
        ...
        self.data = self.produce_imbanlance_data(file_path=file_path, train=train,imbanlance_rate=self.imbanlance_rate,
                                                 forget=forget, input_aug=input_aug)
        self.x = self.data['x']
        self.targets = self.data['y'].tolist()
        self.y = self.data['y'].tolist()
    ...
    def produce_imbanlance_data(self, imbanlance_rate, file_path="/data", train=True, forget=False, input_aug=False):
